...
Каталог `install/` на проекте не редактируем (см. `no-module-install.mdc`). Справочно: файлы установщика Bitrix могут не иметь `strict_types` (legacy-конвенция), но форматирование PSR-12 сохраняй.
